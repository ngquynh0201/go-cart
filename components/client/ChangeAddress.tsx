...
import { changeAddress } from '@/lib/actions/user.action';

export default function ChangeAddress({ id, address }: { id: string; address: AddressType | null | undefined }) {
    ...
    const [state, formAction] = useFormState(changeAddress, {
        success: false,
        error: false,
    });
    ...
    return (
        <div className="mt-16 pb-16 max-w-7xl mx-auto">
            <p className="text-2xl md:text-3xl text-gray-500">
                Thay đổi địa chỉ <span className="font-semibold text-primary">giao hàng</span>
            </p>
