    ...
    const linkSections = [
        {
            ...
            links: [
                ...
                { text: 'Tai nghe đầu', path: '/', icon: null },
    ...
    return (
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">
                            Chào mừng bạn đến với gocart, điểm đến cuối cùng của bạn để mua những tiện ích mới nhất và
                            thông minh nhất. Từ điện thoại thông minh và đồng hồ thông minh cho đến các phụ kiện thiết
                            yếu, chúng tôi mang đến cho bạn những cải tiến tốt nhất — tất cả ở cùng một nơi.
                        </p>
                ...
                <p className="py-4 text-sm text-slate-500">Bản quyền 2025 © gocart All Right Reserved.</p>
            </div>
        </footer>
    );
}
