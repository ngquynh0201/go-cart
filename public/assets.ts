...
export const ourSpecsData = [
    {
        ...
        description:
            'Tận hưởng giao hàng nhanh chóng, miễn phí cho mọi đơn hàng không cần điều kiện, chỉ cần đến tận nơi đáng tin cậy.',
        icon: SendIcon,
        accent: '#05DF72',
    },
    {
        title: '7 Ngày Đổi trả dễ dàng',
        description: 'Thay đổi ý định của bạn? Đừng lo lắng. Trả lại bất kỳ mặt hàng nào trong vòng 7 ngày.',
        icon: ClockFadingIcon,
        accent: '#FF8904',
    },
    {
        title: 'Hỗ trợ khách hàng 24/7',
        description: 'Chúng tôi ở đây vì bạn. Nhận trợ giúp từ chuyên gia với bộ phận hỗ trợ khách hàng của chúng tôi.',
        icon: HeadsetIcon,
        accent: '#A684FF',
    },
];
